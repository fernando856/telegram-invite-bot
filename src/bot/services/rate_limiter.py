...
class RateLimitStatus:
    ...
    is_limited: bool
    cooldown_until: Optional[TIMESTAMP WITH TIME ZONE]
...
class RateLimiter:
    ...
    def __init__(self):
        ...
        self.user_cooldowns: Dict[Tuple[int, RateLimitType], TIMESTAMP WITH TIME ZONE] = {}
